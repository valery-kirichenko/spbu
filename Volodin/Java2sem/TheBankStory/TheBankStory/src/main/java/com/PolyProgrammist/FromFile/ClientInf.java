...
public class ClientInf {
    ...
    private List<CreditInf> credits = new ArrayList<CreditInf>();

    public ClientInf(int id, String passport, boolean hasoldpas, String oldpas, Date birthDate, String name, String family, String father, String phone) {
        this.id = id;
    ...
    public List<CreditInf> getCredits() {
        return credits;
    }

    public void setCredits(List<CreditInf> credits) {
