...
public class DBConfig implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        template.execute("CREATE TABLE IF NOT EXISTS clients(id INTEGER, name VARCHAR(255)," +
                ...
                "oldPass INTEGER NULL, birthday VARCHAR(20))");
        template.execute("CREATE TABLE IF NOT EXISTS credits(NewID INTEGER AUTO_INCREMENT, clientId INTEGER, startSum DOUBLE," +
