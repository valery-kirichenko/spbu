...
public class MyUI extends UI {
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        creditGrid.addColumn(Credits::getCreId).setCaption("Credit ID ").setWidth(100);
        creditGrid.addColumn(Credits::getCliId).setCaption("Client ID").setWidth(100);
        ...
        buttonAddCredit.addClickListener(clickEvent -> {
            if (IdClientSelected.getValue() != null) {
                ...
                credit.setCliId(Integer.parseInt(IdClientSelected.getValue()));
        ...
        buttonAddClient.addClickListener(clickEvent -> {
            ...
            newClient.setDate(clientDate.getValue());
