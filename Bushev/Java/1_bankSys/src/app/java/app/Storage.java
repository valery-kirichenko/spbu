...
import static app.DefaultReader.PATH;
...
public class Storage {
    ...
    private void insertClient(Client client) throws Exception {
        ...
        statement.setInt(1, Integer.parseInt(client.id));
        statement.setString(2, client.name);
        statement.setString(3, client.surname);
        statement.setString(4, client.middlename);
        statement.setLong(5, Long.parseLong(client.phone));
        statement.setInt(6, Integer.parseInt(client.passport));
        statement.setString(7, client.date.toString());
        statement.setInt(8, client.oldPassport.isEmpty() ? 0 : Integer.parseInt(client.oldPassport));
        statement.executeUpdate();
    }
