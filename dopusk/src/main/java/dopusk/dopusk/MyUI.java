...
public class MyUI extends UI {
    ...
    @Autowired
    private ClientsWithExpiryCredit expiryClients;

    @Autowired
    private ExpiryCredits showExpiry;
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        creditGrid.addColumn(Credits::getClientId).setCaption("Client ID").setWidth(100);
        ...
        buttonAddCredit.addClickListener(clickEvent -> {
            if (IdClientSelected.getValue() != null) {
                ...
                credit.setClientId(Integer.parseInt(IdClientSelected.getValue()));
