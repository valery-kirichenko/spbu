...
public class ClientControlImpl implements ClientControl {
    ...
    public void saveNewClient(Clients newClient) {
        ...
        template.execute(query, (PreparedStatementCallback<Object>) preparedStatement -> {
            ...
            preparedStatement.setString(4, newClient.getmName());
            preparedStatement.setString(5, newClient.getPh());
            preparedStatement.setString(6, newClient.getNewPass());
            preparedStatement.setString(7, newClient.getData());
            preparedStatement.setString(8, newClient.getOldPass());
