    ...
    public void clientsList(List<Credits> credits, List<Clients> clients) {
        ...
        for (int i = 0; i < clients.size(); i++) {
            ...
            for (int j = 0; j < clients.get(i).getCreditsList().size(); j++) {
                ...
                if (Double.parseDouble(clients.get(i).getCreditsList().get(j).getVyp()) < Double.parseDouble(clients.get(i).getCreditsList().get(j).getOst()) && currentDate.compareTo(date) == -1) {
                    k++;
                }
            }
            if (k > 0)
                System.out.println(clients.get(i).getId() + " " + clients.get(i).getName() + " " + clients.get(i).getOt() + " " + clients.get(i).getFam() + " " + clients.get(i).getSot() + " " + clients.get(i).getPas1() + " " + clients.get(i).getDate() + " " + clients.get(i).getPas2() + " ");
        }
    }
    ...
    public void creditsList(List<Credits> credits, List<Clients> clients) {
        ...
        for (int i = 0; i < clients.size(); i++) {
            ...
            for (int j = 0; j < clients.get(i).getCreditsList().size(); j++) {
                ...
                if (Double.parseDouble(clients.get(i).getCreditsList().get(j).getVyp()) < Double.parseDouble(clients.get(i).getCreditsList().get(j).getOst()) && currentDate.compareTo(date) == -1) {
                    System.out.println(clients.get(i).getCreditsList().get(j).getId() + " " + clients.get(i).getCreditsList().get(j).getSum() + " " + clients.get(i).getCreditsList().get(j).getPer() + " " + clients.get(i).getCreditsList().get(j).getVyp() + " " + clients.get(i).getCreditsList().get(j).getOst() + "\n");
                    k++;
                }
            }
            if (k == 0)
    ...
    public void total(List<Credits> credits, List<Clients> clients) {
        ...
        for (int i = 0; i < clients.size(); i++) {
            ...
            for (int j = 0; j < clients.get(i).getCreditsList().size(); j++) {
                ...
                if (Double.parseDouble(clients.get(i).getCreditsList().get(j).getVyp()) < Double.parseDouble(clients.get(i).getCreditsList().get(j).getOst()) && currentDate.compareTo(date) == -1) {
                    k+=(Double.parseDouble(clients.get(i).getCreditsList().get(j).getOst())-Double.parseDouble(clients.get(i).getCreditsList().get(j).getVyp()));
                }
            }
            if (k == 0)
